...
$wwaotml_default_email_template = __('<p>Hi {% username %},</p>
<p>You have requested an one-time login link on {% sitename %}, please <a href="{% loginurl %}">click here</a> to login. The link can only be used once and expires in {% expiretime %} minute(s).</p>
